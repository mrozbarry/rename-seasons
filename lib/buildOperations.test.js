...
test('parses correctly', async (t) => {
  const filesIn = [
    ...
    '/tmp/show/season 2/show Season 02 Episode 1 - The First Episode.mp4',
  ];
  ...
  t.deepEqual(ops, [
    ...
    ['/tmp/show/season 2/show Season 02 Episode 1 - The First Episode.mp4', '/tmp/show/S02E01 - The First Episode.mp4'],
  ]);
});
